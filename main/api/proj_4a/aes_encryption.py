...
# Example usage of AesEncryption class, uncomment everything below and run this file for demo output
...
encrypted_text = aes.encrypt_to_base64(plaintext, aes.key_base64)
print("Encrypted ciphertext: " + encrypted_text)

decrypted_text = aes.decrypt_base64(encrypted_text, aes.key_base64)
